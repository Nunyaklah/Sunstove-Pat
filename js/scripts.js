...
*************************************************** **/
	...
	jQuery(window).ready(function () {
		...
		if(jQuery("html").hasClass("chrome") && jQuery("body").hasClass("smoothscroll")) {
			loadScript('js/smoothscroll.js', function() {
				jQuery.smoothScroll();
			});
		}
		/* --- */
 ...
 **************************************************************** **/
	function _onepageNav() {
		...
		if(_container.length > 0) {
			...
			loadScript('js/jquery.nav.min.js', function() {
 ...
 **************************************************************** **/
	function _flexslider() {
		...
		if(_container.length > 0) {
			...
			loadScript('js/slider.flexslider/jquery.flexslider-min.js', function() {
 ...
 **************************************************************** **/
	function _youtubeBG() {
		...
		if(_container.length > 0) {
			loadScript('js/jquery.mb.YTPlayer.min.js', function() {
 ...
 **************************************************************** **/
	function _wrotate() {
		...
		if(_container.length > 0) {
			...
			loadScript('js/jquery.simple-text-rotator.min.js', function() {
 ...
 **************************************************************** **/
	function _lazyload() {
		...
		if(_container.length > 0) {
			loadScript('js/jquery.lazyload.min.js', function() {
 ...
 **************************************************************** **/
	function _misc() {
		...
		if(file_container.length > 0) {
			loadScript('js/custom.fle_upload.js');
		}
 ...
 **************************************************************** **/
	function _countDown() {
		...
		if(_container.length > 0 || _container2.length > 0) {
			...
			loadScript('js/jquery.countdown.pack.min.js', function() {
 ...
 **************************************************************** **/
	function _toastr(_message,_position,_notifyType,_onclick) {
		...
		if(_btn.length > 0 || _message != false) {
			...
			loadScript('js/toastr.js', function() {
				// toastr.clear();
 ...
 **************************************************************** **/
	function _charts() {
		...
		if(_container.length > 0) {
			...
			loadScript('js/jquery.easypiechart.min.js', function() {
 ...
 **************************************************************** **/
	function _select2() {
		...
		if(_container.length > 0) {
			...
			loadScript('js/select2.full.min.js', function() {
 ...
 **************************************************************** **/
	function _form() {
		...
		if(jQuery('form.validate-plugin').length > 0) {
			...
			loadScript('js/jquery.form.min.js', function() {
				loadScript('js/jquery.validation.min.js');
			});
		...
		if(jQuery('form.validate').length > 0) {
			...
			loadScript('js/jquery.form.min.js', function() {
				loadScript('js/jquery.validation.min.js', function() {
